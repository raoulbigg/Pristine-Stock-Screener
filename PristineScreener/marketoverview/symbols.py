...
class Symbols(object):
    ...
    #Get symbols of all US stocks. Regularly updated.
    def USsymbols(self):
        symbols = []
        r = requests.get("https://raw.githubusercontent.com/rreichel3/US-Stock-Symbols/main/all/all_tickers.txt")
        data = r.text
    ...
    def stocks500k(self):
        symbols = []
        f = open("stocks500k.txt", "r").readlines()
        for symbol in f:
            symbols.append(symbol.strip())
        return symbols


    #Etoro get US stock symbols
